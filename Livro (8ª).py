...
print(f'Quantidade de pessoas informadas que tem idade acima de 50 {idade50}. Foram informadas {peso60} pessoas com peso inferior a 60kg')

if idade50 <= 0:
    print(f'Não foram informadas pessoas acima de 50 anos. Foram informadas {peso60} pessoas com peso inferior a 60kg')
elif peso60 <= 0:
    print(f'Esta é a quantidade de pessoas que tem idade acima de 50 {idade50}. Não foram informadas pessoas com o peso abaixo de 60kg')
else:
     print(f'Não foram informadas pessoas acima de 50 anos. Não foram informadas pessoas com o peso abaixo de 60kg')
